...
-- Started on 2014-07-15 23:04:17 VET
...
SELECT pg_catalog.setval('tbusiness_partner_branch_id_seq', 1, true);
...
SELECT pg_catalog.setval('tinput_measure_unit_id_input_measure_unit_seq', 1, true);
...
SELECT pg_catalog.setval('titem_id_seq', 1, true);
...
SELECT pg_catalog.setval('toutput_measure_unit_id_output_measure_unit_seq', 1, true);


-- Completed on 2014-07-15 23:04:17 VET
