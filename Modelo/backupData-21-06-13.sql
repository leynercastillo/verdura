...
-- Started on 2013-06-21 16:36:15
...
SELECT pg_catalog.setval('titem_id_seq', 2, true);
...
INSERT INTO tbasic_data (id_basic_data, parent_id_basic, id_data_type, name, description, editable, status) VALUES (19, NULL, 7, 'gr', 'UNIDAD DE MEDIDA DE PESO', true, 'A');
...
INSERT INTO titem (id_item, code, name, washable, cost, price, weight_unit, unit_car, type, status) VALUES (1, '654321', 'cambur', false, 0, 0, 1, 18, 17, 'A');
...
-- Completed on 2013-06-21 16:36:16
