...
-- Started on 2014-07-31 20:57:55 VET
...
--
-- TOC entry 2026 (class 0 OID 19657)
...
--
-- TOC entry 2031 (class 0 OID 19678)
...
--
-- TOC entry 2032 (class 0 OID 19684)
...
--
-- TOC entry 2028 (class 0 OID 19665)
...
--
-- TOC entry 2029 (class 0 OID 19671)
...
--
-- TOC entry 2022 (class 0 OID 19641)
...
--
-- TOC entry 2024 (class 0 OID 19649)
...
--
-- TOC entry 2040 (class 0 OID 19715)
...
--
-- TOC entry 2043 (class 0 OID 19728)
...
--
-- TOC entry 2046 (class 0 OID 19741)
-- Dependencies: 186 2043 2053
-- Data for Name: torder; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO torder (id_order, id_bp_branch, order_number, bp_name, order_date, delivery_date, rif, bp_branch_address, status) VALUES (5, 3, 4, 'COOPERATIVA POPULAR', '2014-07-27 14:58:24.377', '2014-07-27 14:58:24.377', '12345678', 'AV LA POPULAR', 'A');


--
-- TOC entry 2048 (class 0 OID 19750)
...
--
-- TOC entry 2034 (class 0 OID 19691)
...
--
-- TOC entry 2050 (class 0 OID 19758)
...
--
-- TOC entry 2041 (class 0 OID 19721)
...
--
-- TOC entry 2038 (class 0 OID 19707)
...
--
-- TOC entry 2052 (class 0 OID 19766)
-- Dependencies: 192 2024 2034 2046 2053
-- Data for Name: torder_detail; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO torder_detail (id_order_detail, id_order, id_item, item_name, quantity, measure_unit, status) VALUES (1, 5, 3, 'ACELGA', 2, 23, 'A');
...
SELECT pg_catalog.setval('torder_detail_id_seq', 1, true);
...
SELECT pg_catalog.setval('torder_ordernumber_seq', 4, true);


--
-- TOC entry 2036 (class 0 OID 19699)
...
-- Completed on 2014-07-31 20:57:56 VET
